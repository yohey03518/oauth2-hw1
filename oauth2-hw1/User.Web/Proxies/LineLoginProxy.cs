...
public class LineLoginProxy
{
    ...
    public string GetLoginUrl(string requestHost)
    {
        ...
        return $"https://access.line.me/oauth2/v2.1/authorize?response_type={responseType}&client_id={ClientId}&state=123123&scope=profile%20openid%20email&redirect_uri={string.Format(CallbackUrlFormat, requestHost)}";
    }
